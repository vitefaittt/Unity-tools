...
public class AutoMaterial_Settings : ScriptableObject {
    /// <summary>
    ...
    public static AutoMaterial_Settings Create()
    {
        AutoMaterial_Settings newSuffixes = (AutoMaterial_Settings)CreateInstance(typeof(AutoMaterial_Settings).Name);
        AssetDatabase.CreateAsset(newSuffixes, AssetDatabase.GenerateUniqueAssetPath(defaultFolderPath + "/AutoMaterial settings.asset"));
        return newSuffixes;
    }
